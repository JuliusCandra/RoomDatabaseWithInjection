...
import com.dev_candra.todolistapp.entity.PreferenceManager.PreferenceKeys as PreferenceKeys
...
class PreferenceManager @Inject constructor(@ApplicationContext context: Context){
    ...
    val preferencesFlow = dataStore.data
        ...
        .map { preferences ->
            ...
            FilterPreferences(sortOrder,hideCompleted = false)
        }
    ...
    suspend fun updateHighCompleted(hideCompleted: Boolean){
        dataStore.edit {preferences ->
        ...
        private object PreferenceKeys {
            ...
            val HIDE_COMPLETED = preferencesKey<Boolean>("hide_compeleted")
        }
}